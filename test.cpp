...
int main()
{
	...
	std::string encoded = base64::base64_encode(reinterpret_cast<const unsigned char *>(orig.c_str()), orig.length());
	...
	std::string rest0_encoded = base64::base64_encode(reinterpret_cast<const unsigned char *>(rest0_original.c_str()),
		rest0_original.length());
	std::string rest0_decoded = base64::base64_decode(rest0_encoded);
	...
	std::string rest1_encoded = base64::base64_encode(reinterpret_cast<const unsigned char *>(rest1_original.c_str()),
		rest1_original.length());
	std::string rest1_decoded = base64::base64_decode(rest1_encoded);
	...
	std::string rest2_encoded = base64::base64_encode(reinterpret_cast<const unsigned char *>(rest2_original.c_str()),
		rest2_original.length());
	std::string rest2_decoded = base64::base64_decode(rest2_encoded);
	...
	std::string a17_encoded = base64::base64_encode(a17_orig, false);
	std::string a17_encoded_url = base64::base64_encode(a17_orig, true);
	...
	if (base64::base64_decode(a17_encoded_url) != a17_orig)
	{
		std::cout << "Failed to decode a17 (url)" << std::endl;
		all_tests_passed = false;
	}

	if (base64::base64_decode(a17_encoded) != a17_orig)
	{
	...
	std::string s_6364_encoded = base64::base64_encode(s_6364, false);
	std::string s_6364_encoded_url = base64::base64_encode(s_6364, true);
	...
	if (base64::base64_decode(s_6364_encoded) != s_6364)
	{
		std::cout << "Failed to decode s_6364_encoded" << std::endl;
		all_tests_passed = false;
	}

	if (base64::base64_decode(s_6364_encoded_url) != s_6364)
	{
